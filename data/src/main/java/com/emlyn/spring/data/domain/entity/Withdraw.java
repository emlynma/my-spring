...
import com.emlyn.spring.data.domain.enums.status.WithdrawBizStatus;
import com.emlyn.spring.data.domain.enums.status.WithdrawStatus;
import lombok.Data;

import java.util.Date;

@Data
@TableName(value = "withdraw", autoResultMap = true)
public class Withdraw {
    ...
    private WithdrawBizStatus bizStatus;
    ...
    public boolean isCompleted() {
        return WithdrawStatus.checkFinal(status);
    }
